from render.corpus.chn_corpus import ChnCorpus
from render.corpus.eng_corpus import EngCorpus
from render.corpus.list_corpus import ListCorpus
from render.corpus.random_corpus import RandomCorpus
