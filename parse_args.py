...
def parse_args():
    ...
    parser.add_argument('--num_img', type=int, default=1, help="图片数量")

    parser.add_argument('--length', type=int, default=2, help='文字数量')
    parser.add_argument('--watermark_dir',type=str, default='./data/watermaker', help='水印文件夹')
